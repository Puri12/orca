...
// Why: omo grows the closed ensureAgentSession enum; older hosts answer invalid_argument.
export const AGENT_SESSION_OMO_RESUME_RUNTIME_CAPABILITY = 'agent-session.omo-resume.v1' as const
